...
export function AboutWorkflowSection() {
  return (
    <section id="about-workflow" className="snap-section relative flex flex-col justify-between items-center px-6 py-12 md:py-16 bg-[#071114] text-white">
      ...
      <div className="flex-1 flex flex-col justify-center max-w-6xl w-full mx-auto my-auto relative z-10 space-y-10 md:space-y-14">
