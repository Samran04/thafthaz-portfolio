...
import { Video, Camera, Palette, Sparkles, Film, Layers, ArrowUpRight } from 'lucide-react';
...
export function ServicesSection({ services }: ServicesSectionProps) {
  return (
    <section id="services" className="snap-section relative flex flex-col justify-between items-center px-6 py-12 md:py-16 bg-[#030d10] text-white">
      ...
      {/* Top Header clearance for nav */}
      <div className="h-6 md:h-10" />

      <div className="flex-1 flex flex-col justify-center w-full max-w-6xl mx-auto my-auto relative z-10 space-y-8 md:space-y-12">
            ...
            return (
              ...
              >
                ...
                <div className="pt-6 border-t border-white/5 flex items-center justify-between mt-6">
                  <Link
                    href="/work"
                    className="inline-flex items-center gap-1.5 text-[10px] uppercase tracking-[0.2em] font-semibold text-[#8ea1a7] group-hover:text-[#39FF14] transition"
                  >
                    View Portfolio <ArrowUpRight size={12} className="text-[#39FF14] transition group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                  </Link>
                </div>
              </motion.div>
            );
